...
do {
  ...
  if ($Wert === true and strlen( $Antwort ) >= 97) {
    ...
    $aktuelleDaten["Nennspannung"] = (int)$Teile[0];
    $aktuelleDaten["Nennstrom"] = (int)$Teile[1];
    $aktuelleDaten["AC_Nennspannung"] = (int)$Teile[2];
    $aktuelleDaten["AC_Nennfrequenz"] = (int)$Teile[3];
    $aktuelleDaten["AC_Nennstrom"] = (int)$Teile[4];
    $aktuelleDaten["AC_Scheinnennleistung"] = (int)$Teile[5];
    $aktuelleDaten["AC_Wirknennleistung"] = (int)$Teile[6];
    $aktuelleDaten["Batterienennspannung."] = (int)$Teile[7];
    $aktuelleDaten["Batterienachladung"] = (int)$Teile[8];
    $aktuelleDaten["Batterieunterspannung"] = (int)$Teile[9];
    $aktuelleDaten["Batterieladespannung"] = (int)$Teile[10];
    $aktuelleDaten["Erhaltungsladung"] = (int)$Teile[11];
    $aktuelleDaten["Batterietyp"] = (int)$Teile[12];
    $aktuelleDaten["MaxNetzLadung"] = (int)$Teile[13];
    $aktuelleDaten["MaxPVLadung"] = (int)$Teile[14];
    $aktuelleDaten["InputVoltageRange"] = (int)$Teile[15];
    $aktuelleDaten["OutputPriority"] = (int)$Teile[16];
    $aktuelleDaten["Ladestatus"] = (int)$Teile[17];
    $aktuelleDaten["MaxParallelGeraete"] = (int)$Teile[18];
    $aktuelleDaten["Maschinentyp"] = $Teile[19];
    $aktuelleDaten["Topologie"] = $Teile[20];
    $aktuelleDaten["OutputMode"] = $Teile[21];
    $aktuelleDaten["BatterieMinSpannung"] = (int)$Teile[22];
  }
  ...
  if ($Wert === true and strlen( $Antwort ) == 110) {
    $Teile = explode( " ", substr( $Antwort, 1, - 3 ));
    $aktuelleDaten["Netzspannung"] = (int)$Teile[0];
    $aktuelleDaten["Netzfrequenz"] = (int)$Teile[1];
    $aktuelleDaten["AC_Ausgangsspannung"] = (int)$Teile[2];
    $aktuelleDaten["AC_Ausgangsfrequenz"] = (int)$Teile[3];
    $aktuelleDaten["AC_Scheinleistung"] = (int)$Teile[4];
    $aktuelleDaten["AC_Wirkleistung"] = (int)$Teile[5];
    $aktuelleDaten["Ausgangslast"] = (int)$Teile[6];
    $aktuelleDaten["BUSspannung"] = (int)$Teile[7];
    $aktuelleDaten["Batteriespannung"] = (int)$Teile[8];
    $aktuelleDaten["Batterieladestrom"] = (int)$Teile[9];
    $aktuelleDaten["Batteriekapazitaet"] = (int)$Teile[10];
    $aktuelleDaten["Temperatur"] = ((int)$Teile[11] / 10);
    $aktuelleDaten["Solarstrom"] = (int)$Teile[12];
    $aktuelleDaten["Solarspannung"] = (int)$Teile[13];
    $aktuelleDaten["BatterieSCCSpannung"] = (int)$Teile[14];
    $aktuelleDaten["Batterieentladestrom"] = (int)$Teile[15];
    $aktuelleDaten["Optionen"] = $Teile[16];
    $aktuelleDaten["BatterieOffsetFan"] = $Teile[17];
    $aktuelleDaten["EEPROM"] = $Teile[18];
    $aktuelleDaten["Solarleistung"] = (int)$Teile[19];
  ...
  if ($Wert === true and strlen( $Antwort ) == 70) {
    $Teile = explode( " ", substr( $Antwort, 1, - 3 ));
    $aktuelleDaten["Solarstrom2"] = (int)$Teile[0];
    $aktuelleDaten["Solarspannung2"] = (int)$Teile[1];
    $aktuelleDaten["Solarleistung2"] = (int)$Teile[2];
  ...
  if ($Wert === true and strlen( $Antwort ) == 82 ) {
    ...
    $aktuelleDaten["AC_Wirkleistung"] = (int)$Teile[4];
    $aktuelleDaten["AC_Ausgangslast"] = (int)$Teile[5];
    $aktuelleDaten["Batteriespannung"] = (int)$Teile[6];
    $aktuelleDaten["Batteriekapazitaet"] = (int)$Teile[7];
    $aktuelleDaten["Batterieladestrom"] = (int)$Teile[8];
    $aktuelleDaten["Batterieentladestrom"] = (int)$Teile[9];
    $aktuelleDaten["Solarspannung"] = (int)$Teile[10];
    $aktuelleDaten["Solarstrom"] = (int)$Teile[11];
    $aktuelleDaten["Solarleistung"] = (int)$Teile[12];
    $aktuelleDaten["MaxSolarTagesleistung"] = (int)$Teile[13];
    $aktuelleDaten["MaxSolarGesamtleistung"] = ((int)$Teile[14]*1000);
