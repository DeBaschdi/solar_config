  ...
  <div class="row article-header">
    <div class="coffee-span-12 coffee-offset-0 coffee-768-span-12">  
      <fieldset style="padding:5px 20px; border: 2px solid #C5D8E1; border-radius: 6px; background: white;vertical-align:middle;">
        ...
        <div style="float:left; width:100%; height:450px; vertical-align:middle;" ><p style="padding-top: 10px; text-align:left;"><?php header("refresh: 5;"); exec('tail -n 17 /var/www/log/solaranzeige.log', $solarlogs); foreach($solarlogs as $solarlog) {echo "<br />".$solarlog;} ?></p></div>
        <p style="clear: both; text-align: center;"></p> 
      </fieldset>
    </div>
  </div>
